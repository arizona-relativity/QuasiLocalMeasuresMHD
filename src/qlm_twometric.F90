     ...
     do i = 1+qlm_nghoststheta(hn), qlm_ntheta(hn)-qlm_nghoststheta(hn)
        ...
        do aa=1,2
           do b=1,2
              ...
              do c=1,3
                 do d=1,3
                    qq(aa,b) = qq(aa,b) + gg(c,d) * ee(c,aa) * ee(d,b)
                 end do
              end do
           end do
        end do
           ...
           do b=1,2
              do c=1,2
                 ...
                 do d=1,3
                    do e=1,3
                       do f=1,3
                          dqq(aa,b,c) = dqq(aa,b,c) + dgg(d,e,f) * ee(d,aa) * ee(e,b) * ee(f,c)
                       end do
                       dqq(aa,b,c) = dqq(aa,b,c) + gg(d,e) * dee(d,aa,c) * ee(e,b)
                       dqq(aa,b,c) = dqq(aa,b,c) + gg(d,e) * ee(d,aa) * dee(e,b,c)
                    end do
                 end do
              end do
           end do
