...
module qlm_variables
  ...
  CCTK_REAL, allocatable, dimension(:,:) :: &
       ...
       qlm_alpha, &
       qlm_spatial_vol_in_qlm, &
       qlm_betax, qlm_betay, qlm_betaz, &
       qlm_Bx, qlm_By, qlm_Bz, &
       qlm_ttt, &
...
contains
  ...
  subroutine allocate_variables(ntheta, nphi)
    ...
    allocate(qlm_spatial_vol_in_qlm(ntheta,nphi))
    allocate(qlm_betax(ntheta,nphi))
    allocate(qlm_betay(ntheta,nphi))
    allocate(qlm_betaz(ntheta,nphi))
    allocate(qlm_Bx(ntheta,nphi))
    allocate(qlm_By(ntheta,nphi))
    allocate(qlm_Bz(ntheta,nphi))
    ...
    qlm_dkzzz = TAT_nan()
    qlm_alpha = TAT_nan()
    qlm_spatial_vol_in_qlm = TAT_nan()
    qlm_betax = TAT_nan()
    qlm_betay = TAT_nan()
    qlm_betaz = TAT_nan()
    qlm_Bx = TAT_nan()
  ...
  subroutine deallocate_variables
    ...
    deallocate(qlm_spatial_vol_in_qlm)
